...
def test_sex_fractional_prints_via_rat_coercion(tmp_path):
...
def test_ybc_7289_sqrt2(tmp_path):
    ...
    # 1;24 51 10 = 30547/21600 ≈ 1.41421296 — good to five decimal places.
    _, out, _ = run('fn main() -> i32 { println(1;24 51 10)\n 0 }', tmp_path)
    assert out == b"30547/21600\n"
